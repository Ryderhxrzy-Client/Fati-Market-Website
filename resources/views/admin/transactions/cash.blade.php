...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h3 class="text-lg font-bold text-gray-900">Cash Transactions</h3>
            <p class="text-sm text-gray-600">View all cash transactions</p>
        </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                ...
                                <p class="text-gray-500">No cash transactions found</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
